...
# Best is PK 0.14 - this plot actually looked great
pK <- 0.14
...
# 7.20%	14,850	9,000
# 8.00%	16,500	10,000
nExp_poi <- round(0.088*nrow(seurat_data@meta.data))  
...
seurat_data$Doublet_finder <- seurat_data$DF.classifications_0.25_0.14_827
