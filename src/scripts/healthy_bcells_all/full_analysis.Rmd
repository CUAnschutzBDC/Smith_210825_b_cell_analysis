...
samples <- list("healthy_bcells_all" = c("single"))
...
names(sample_colors) <- c("healthy_bcells_all")

celltype_colors <- LaCroixColoR::lacroix_palette("Pamplemousse", 5)
...
sample_info <- sample_list[["healthy_bcells_all"]]
...
There were only 56 cells that passed all of the filters
...
### Cells matching 2
It seems like two cutoffs is more promising, especially looking at cluster 5.
