...
plot_list <- plotDimRed(seurat_data,
                        c("IgM_cutoff", "IgD_cutoff", "CD21_cutoff"),
                        plot_type = "rna.umap")
...
plot_3 <- plotDimRed(seurat_data, "celltype_cluster",
                     ...
                     color = celltype_cluster_colors)[[1]]
...
I clustered both using the RNA alone and using a weighted combination of the RNA and ADT (surface protein). Generally, a similar weight was given to both the RNA and ADT for all cells. Overall, the results of the two clustering approaches are similar but not identical. Based on my understanding, your subset of interest would be cluster 1 from the RNA custering and cluster 2 from the combined clutering. I am showing violin plots for both the RNA clustering and the combined clustering below

## Clustering based on RNA alone

### Plots of ADTs {.tabset}
```{r "plot-adts-cluster6", echo = F}
...
cluster_colors_RNA <- cluster_colors[1:2]
...
## Clustering based on RNA and ADT
